#!/usr/bin/env bash
#
# talk-craft skill 安裝腳本（macOS / Linux）
...
SRC_DIR="$SCRIPT_DIR/skills/talk-craft"
SKILLS_DIR="$HOME/.claude/skills"
DEST_DIR="$SKILLS_DIR/talk-craft"
...
echo ""
echo "驗證安裝："
echo "  head -5 ~/.claude/skills/talk-craft/SKILL.md"
echo ""
echo "建議在做簡報的專案 CLAUDE.md 加入："
echo "  本專案簡報內容遵循 talk-craft skill，敘事與論證規範以該 skill 鐵則為準。"
